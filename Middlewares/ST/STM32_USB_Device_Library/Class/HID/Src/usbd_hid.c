...
__ALIGN_BEGIN static uint8_t USBD_HID_CfgFSDesc[USB_HID_CONFIG_DESC_SIZ]  __ALIGN_END =
{
  ...
  HID_SNES_GAMEPAD_REPORT_DESC_SIZE,/*wItemLength: Total length of Report descriptor*/
  0x00,
    ...
    case USB_REQ_TYPE_STANDARD:
      switch (req->bRequest)
      {
        ...
        case USB_REQ_GET_DESCRIPTOR:
          ...
          {
            len = MIN(HID_SNES_GAMEPAD_REPORT_DESC_SIZE, req->wLength);
            pbuf = HID_SNES_GAMEPAD_ReportDesc;
          }
